            ...
            var httpCall = function() {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('.col-tracks .item:not(.item-temp)').remove();
                        $('.col-tracks .item-temp').removeClass('item-temp');
                        ...
                        $('.col-albums .item:not(.item-temp)').remove();
                        $('.col-albums .item-temp').removeClass('item-temp');
